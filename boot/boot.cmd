...
if test "${console}" = "serial"; then setenv consoleargs "console=ttyS2,1500000"; fi
if test "${console}" = "both"; then setenv consoleargs "console=tty1 console=ttyS2,1500000"; fi
